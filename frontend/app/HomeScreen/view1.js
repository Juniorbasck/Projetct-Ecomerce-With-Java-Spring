...
.controller('View1Ctrl', ['$scope', '$http', function($scope, $http) {
  ...
  $http.get('http://junior-trabalho.myftp.org:8080/products')
    ...
    $scope.adicionarNovoProduto = function() {
      ...
      $http.post('http://junior-trabalho.myftp.org:8080/products', novoProduto)
          .then(function(response) {
              ...
              return $http.get('http://junior-trabalho.myftp.org:8080/products');
          })
          .then(function(response) {
              $scope.produtos = response.data;
          })
     ...
     $scope.adicionarAoCarrinho = function(produtoId) {
      ...
      $http.post('http://junior-trabalho.myftp.org:8080/items/' + cartId, itemRequest)
          .then(function(response) {
