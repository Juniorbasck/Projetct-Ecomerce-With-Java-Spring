...
angular.module('myApp.view2')
    ...
    function getCartItems() {
        $http.get('http://junior-trabalho.myftp.org:8080/cart/' + cartId)
    ...
    getCartItems(); 
      ...
      $scope.atualizarCarrinho = function() {
        ...
        $http.put('http://junior-trabalho.myftp.org:8080/cart/' + cartId, itemsToUpdate)
        .then(function(response) {
    ...
    $scope.removerDoCarrinho = function(itemId) {
      ...
      $http.delete('http://junior-trabalho.myftp.org:8080/cart/' + cartId + '/' + itemId)
          .then(function(response) {
